...
//loop2 calcs shift val
LOOP2:		LSRS R5, R5, #1		//triggers flag when r5 = 0
			BEQ DONE1
			ADD R4, R4, #1		//increment counter
			B LOOP2

DONE1:		LSR R3, R3, R4		//R3 now contains average
			LDR R5, LENGTH		//reset to use as counter

LOOP3:		SUBS R5, R5, #1
			BMI END				//if neg bc subs is at top of loop & no done condition
			LDR R0, [R6]		//temp reg to do ops
			SUB R0, R0, R3
			STR R0, [R6], #4	//forward
			B LOOP3
